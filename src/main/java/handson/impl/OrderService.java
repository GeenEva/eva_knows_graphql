...
public class    OrderService extends AbstractService {
    ...
    public CompletionStage<Order> createOrder(final Cart cart) {
        // TODO Task16.1 Create a new order from cart

        return
        client.execute(OrderFromCartCreateCommand.of(cart));
    ...
    public CompletionStage<Order> changeState(final Order order, final OrderState state) {
        ...
        return client.execute(OrderUpdateCommand.of(order,
                ChangeOrderState.of(state)));
    }
}
